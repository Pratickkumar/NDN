...
public: // element access
  ...
  Interest&
  setSojourn(time::milliseconds lifetime);
  optional<uint8_t>
  ...
  Interest&
  setHopCount(optional<uint8_t> hopLimit);
...
private:
  ...
  time::milliseconds sojourn = DEFAULT_INTEREST_LIFETIME;
  optional<uint8_t> m_hopLimit;
  optional<uint8_t> hopcount;
  bool m_canBePrefix = false;
  bool m_mustBeFresh = false;
  // hopcount ------------------------- similar to hoplimit
  // sojoroun
  // grep
